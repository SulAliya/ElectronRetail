...
class Network(models.Model):
    ...
    supplier = models.ForeignKey('Network', on_delete=models.SET_NULL, verbose_name='Поставщик', **NULLABLE)
    debt = models.DecimalField(max_digits=10, decimal_places=2, default=0.00,
                               verbose_name='Задолженность перед поставщиком')
    created_at = models.TimeField(auto_now_add=True, **NULLABLE, verbose_name='Время создания')
    level = models.IntegerField(choices=level, verbose_name='Уровень иерархии', default=0)
